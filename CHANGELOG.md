...
- Support for the `v` prefixed version. This enables Flux to use `v`-prefixed image tags as Apps version to automatically update them.
...
[Unreleased]: https://github.com/giantswarm/app/compare/v5.6.0...HEAD
