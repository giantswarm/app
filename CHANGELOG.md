...
- Fix linting issues for golangci-lint v2.0.0.
- Update architect-orb to `giantswarm/architect@dev:ce9a62fb6407cd537b3123a9546847b7b7fb0d0b`.
...
[Unreleased]: https://github.com/giantswarm/app/compare/v7.1.0...HEAD
