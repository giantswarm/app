...
func (v *Validator) validateConfig(ctx context.Context, cr v1alpha1.App) error {
	if key.AppConfigMapName(cr) != "" {
		err := v.validateNameAndNamespaceIsSet(ctx, key.AppConfigMapName(cr), key.AppConfigMapNamespace(cr), "configmap")
		if err != nil {
			return microerror.Mask(err)
		}
	}
	...
	if key.AppSecretName(cr) != "" {
		err := v.validateNameAndNamespaceIsSet(ctx, key.AppSecretName(cr), key.AppSecretNamespace(cr), "secret")
		if err != nil {
			return microerror.Mask(err)
		}
	}
...
func (v *Validator) validateKubeConfig(ctx context.Context, cr v1alpha1.App) error {
	if !key.InCluster(cr) {
		err := v.validateNameAndNamespaceIsSet(ctx, key.KubeConfigSecretName(cr), key.KubeConfigSecretNamespace(cr), "kubeconfig secret")
		if err != nil {
			return microerror.Mask(err)
		}
...
func (v *Validator) validateUserConfig(ctx context.Context, cr v1alpha1.App) error {
	if key.UserConfigMapName(cr) != "" {
		...
		err := v.validateNameAndNamespaceIsSet(ctx, key.UserConfigMapName(cr), key.UserConfigMapNamespace(cr), "configmap")
		if err != nil {
			return microerror.Mask(err)
		}
	}
	...
	if key.UserSecretName(cr) != "" {
		...
		err := v.validateNameAndNamespaceIsSet(ctx, key.UserSecretName(cr), key.UserSecretNamespace(cr), "secret")
		if err != nil {
			return microerror.Mask(err)
		}
	}
...
func (v *Validator) validateNameAndNamespaceIsSet(ctx context.Context, name, namespace, kind string) error {
	if namespace == "" {
