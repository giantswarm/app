...
func Test_ValidateApp(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "case 2: flawless flow with `v` prefixed version",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "kiam",
					Namespace: "eggs2",
		...
		{
			name: "case 3: missing version label",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "dex-app-unique",
					Namespace: "giantswarm",
		...
		{
			name: "case 4: spec.catalog not found",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "dex-app-unique",
					Namespace: "giantswarm",
		...
		{
			name: "case 5: spec.config.configMap not found",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "dex-app-unique",
					Namespace: "giantswarm",
		...
		{
			name: "case 6: spec.config.configMap no namespace specified",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "dex-app-unique",
					Namespace: "giantswarm",
		...
		{
			name: "case 7: spec.config.secret not found",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "dex-app-unique",
					Namespace: "giantswarm",
		...
		{
			name: "case 8: spec.config.secret no namespace specified",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "dex-app-unique",
					Namespace: "giantswarm",
		...
		{
			name: "case 9: spec.kubeConfig.secret not found",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "kiam",
					Namespace: "eggs2",
		...
		{
			name: "case 10: spec.kubeConfig.secret no namespace specified",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "kiam",
					Namespace: "eggs2",
		...
		{
			name: "case 11: spec.userConfig.configMap not found",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "dex-app-unique",
					Namespace: "giantswarm",
		...
		{
			name: "case 12: spec.userConfig.configMap no namespace specified",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "dex-app-unique",
					Namespace: "giantswarm",
		...
		{
			name: "case 13: spec.userConfig.secret not found",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "dex-app-unique",
					Namespace: "giantswarm",
		...
		{
			name: "case 14: spec.userConfig.secret no namespace specified",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "dex-app-unique",
					Namespace: "giantswarm",
		...
		{
			name: "case 15: spec.userConfig.configMap.name incorrect for default catalog app",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "kiam",
					Namespace: "giantswarm",
		...
		{
			name: "case 16: spec.userConfig.secret.name incorrect for default catalog app",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "kiam",
					Namespace: "giantswarm",
		...
		{
			name: "case 17: metadata.name exceeds max length",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
		...
		{
			name: "case 18: legacy version label is rejected",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "kiam",
					Namespace: "eggs2",
		...
		{
			name: "case 19: nginx user values configmap name is not restricted",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "kiam",
					Namespace: "eggs2",
		...
		{
			name: "case 20: spec.kubeConfig.secret no name specified",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "kiam",
					Namespace: "eggs2",
		...
		{
			name: "case 21: skip validation when giantswarm.io/managed-by label equals flux",
			obj: v1alpha1.App{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "kiam",
					Namespace: "eggs2",
